...
from services.user.app.db.database import get_db
from app.models.farmer import FarmerProfile, Farm
from services.user.app.schemas.schemas import FarmerProfileCreate, FarmerProfileUpdate, FarmerProfileOut, FarmerListOut, FarmCreate, FarmOut
from services.user.app.core.dependencies import require_farmer
